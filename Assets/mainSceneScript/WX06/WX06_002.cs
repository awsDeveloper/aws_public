...
public class WX06_002 : MonoBehaviour
{
    DeckScript ms;
    CardScript bs;
    int ID = -1;
    ...
    void chanted()
    {
        ...
        bs.setEffect(lrig, target, Motions.DontAttack);
    ...
    bool check()
    {
        return ms.checkLrigColor(player, cardColorInfo.白) && ms.getFieldAllNum((int)Fields.LIFECLOTH, player) <= 2;
    }
}
